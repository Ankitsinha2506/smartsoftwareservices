...
function BannerPortfolioGrid() {
  return (
    <section className="py-10 bg-white">
      <h2 className="text-2xl font-semibold text-center mb-6 px-4">Facebook banners and Post</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mx-auto max-w-6xl px-4">
